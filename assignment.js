...
/*
 *		This file contains the javascript code for our animals categories page
 */
...
$(document).ready(function(){
	...
	$("#animals-tab").click(function () {
		...
		$(".animaltype").click(function (){
			...
			current_animal_type = animals_data.category[index];


			// displays the photos template
			showTemplate(critter_template, current_animal_type);
